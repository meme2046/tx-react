import type { IArweave, IArweaveData, IArweaveDataList } from "@/types";
...
const createEmptyArweaveTx = (nodeId: string): IArweaveData => {
	return {
...
export const arweaveGraphql = async <T extends IArweaveData>(
	fetchSize: number,
	type: string,
	cursor?: string,
...
export const useArweaveTxInfinite = <T extends IArweaveData>(
	key: string,
	fetchSize: number,
	type: string,
) => {
